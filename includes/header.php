...
<head>
    ...
    <style>
        /* Restaura o negrito natural dos títulos que o Tailwind removeu */
        h1, h2, h3, h4, h5, h6 {
            font-weight: 700 !important; /* Força negrito */
        }
        
        /* Garante que o texto dentro de tags <b> e <strong> também fica negrito */
        strong, b {
            font-weight: 700 !important;
        }

        /* Opcional: Dá um espaçamento extra nos subtítulos de artigos para não ficarem colados */
        .prose h2, .prose h3 {
            margin-top: 1.5em;
            margin-bottom: 0.5em;
        }
