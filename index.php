...
<main>
    ...
    <div class="imagem_de_fundo relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <img src="img/2imagem_campo_fontelo.jpg" alt="Campo de Ténis" id="hero-image" class="absolute inset-0 w-full h-full object-cover opacity-60 transition-opacity duration-500">  
