        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <?php if (isset($_GET['msg']) && $_GET['msg'] == 'enviado'): ?>
                    <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-6 rounded-r shadow-sm flex items-center animate-fade-in-down">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs text-green-600">
                                Verifica a tua caixa de entrada para recuperares a conta.
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <form action="trataLogin.php" method="POST" class="space-y-8">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <a href="recuperar_password.php" class="text-sm text-green-600 hover:underline font-medium">Esqueceu-se da palavra-passe?</a>
                    </div>
